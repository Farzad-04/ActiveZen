...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($goal_type) || empty($target_value) || empty($date_set) || empty($status)) {
        ...
        $sql = "INSERT INTO nutritiongoals (User_id, Nutrient, Target_amount, Date_set, Target_date, Frequency, Priority, Status) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt = $conn->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                ...
                header("Location: /Data_Management_Project/Nutritiongoalsuccessful.php");
...
<head>
    ...
    <style>
        ...
        body::before {
            ...
            right: 0;
            bottom: 0;
            background-image: url('https://t3.ftcdn.net/jpg/08/27/76/54/360_F_827765443_Wmnum2ijGKfnR5iwVOMsiS1iZ1WgvZ5o.jpg');
            background-size: cover;
            ...
            <div class="form-container">
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" id="target_value" name="target_value" class="form-control" value="<?php echo isset($_POST['target_value']) ? $_POST['target_value'] : ''; ?>" required>
                    </div>

                    <div class="form-group mb-3">
                        <label for="date_set">Date Set</label>
                        <input type="date" id="date_set" name="date_set" class="form-control" value="<?php echo isset($_POST['date_set']) ? $_POST['date_set'] : ''; ?>" required>
                    </div>
            ...
            <div class="image-container">
                <div class="image-overlay">
                    <div class="overlay-text">
                        <a href="/Data_Management_Project/allnutritiongoals.php">View Goals</a>
                    </div>
                </div>
                <img src="https://www.myfooddiary.com/blog/asset/1360/set_health_goal_tips.jpg" alt="Nutrition Goal Image">
            </div>
        </div>
    </div>
</body>
